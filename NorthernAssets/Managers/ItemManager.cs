...
public class Item
{
	...
	public List<string> AttackEffects = new();
	...
	public void AssignItemEffects()
	{
		...
		Helpers.UpdateEffects(StartEffects, ref component.m_itemData.m_shared.m_startEffect);
		Helpers.UpdateEffects(HoldEffects, ref component.m_itemData.m_shared.m_holdStartEffect);
		Helpers.UpdateEffects(EquipEffects, ref component.m_itemData.m_shared.m_equipEffect);
		Helpers.UpdateEffects(UnEquipEffects, ref component.m_itemData.m_shared.m_unequipEffect);
		Helpers.UpdateEffects(TriggerEffects, ref component.m_itemData.m_shared.m_triggerEffect);
		Helpers.UpdateEffects(TrailStartEffects, ref component.m_itemData.m_shared.m_trailStartEffect);
		Helpers.UpdateEffects(HitEffects, ref component.m_itemData.m_shared.m_hitEffect);
		Helpers.UpdateEffects(BlockEffects, ref component.m_itemData.m_shared.m_blockEffect);
		Helpers.UpdateEffects(AttackEffects, ref component.m_itemData.m_shared.m_attack.m_startEffect);
		if (!CloneArmorMaterialFrom.IsNullOrWhiteSpace() && ObjectDB.instance.GetItemPrefab(CloneArmorMaterialFrom) is {} prefab)
		{
			if (prefab.TryGetComponent(out ItemDrop prefabItem) && prefabItem.m_itemData.m_shared.m_armorMaterial is
				    { } material)
			{
				component.m_itemData.m_shared.m_armorMaterial = material;
			}
		}
	}
...
public static class PrefabManager
{
	...
	{
		if (assets.LoadAsset<GameObject>(prefabName) is { } prefab)
		{
			RegisterPrefab(prefab, addToObjectDb);
			return prefab;
		}
